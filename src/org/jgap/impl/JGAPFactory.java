...
public class JGAPFactory
  ...
  /**
   * Registers a clone_ICloneable handler that could be retrieved by
   * getCloneHandlerFor(Class).
   *
   * @param a_cloneHandler the ICloneHandler to register
   * @return index of the added clone_ICloneable handler, needed when removeCloneHandler
   * will be called
   *
   * @author Klaus Meffert
   * @since 2.6
  ...
  /**
   * Removes a clone_ICloneable handler at a given index (which is obtained from
   * registerCloneHandler).
   *
   * @param a_index the index of the clone_ICloneable handler to remove
  ...
  /**
   * Retrieves a clone_ICloneable handler capable of clone_ICloneable the given class.
   *
   * @param a_obj the object to clone_ICloneable (maybe null)
   * @param a_classToClone the class to clone_ICloneable an object of (maybe null)
   * @return the clone_ICloneable handler found capable of clone_ICloneable the given

 ...
 * @since 2.0
 */
public class SHERIF_GreedyCrossover
     ...
     */
    public SHERIF_GreedyCrossover(Configuration a_configuration, Salesman s)
            throws InvalidConfigurationException {
    ...
    public void operate(final Population a_population,
        ...
        for (int i = 0; i < numCrossovers; i++) {
            ...
            IChromosome firstMate = (IChromosome) origChrom1.clone_ICloneable();
            IChromosome origChrom2 = a_population.getChromosome(generator.nextInt(size));
            IChromosome secondMate = (IChromosome) origChrom2.clone_ICloneable();
...
//                Gene n1after = findNext(a_g1, n1);
//                Gene n2after = findNext(a_g2, n2);
//                if (n1after != null && n2after != null) {
//
//                    pick1 = (salesman.distance(last, n1) < salesman.distance(last, n2)
//                            && salesman.distance(n1after, n1) < salesman.distance(n2after, n2));
//                } else {
                    pick1 = salesman.distance(last, n1) < salesman.distance(last, n2);
//                }
            }
    ...
    public int compareTo(final Object a_other) {
        ...
        SHERIF_GreedyCrossover op = (SHERIF_GreedyCrossover) a_other;

...
public class GPConfiguration
  ...
  /**
   * TRUE: Do not clone_ICloneable command genes when creating a new GP program in
   * ProgramChromosome.
   *
   * @author Klaus Meffert
   * @since 3.4.3
...
//      result.m_config = new ConfigurationConfigurable();
  ...
  /**
   * Decide whether to clone_ICloneable command genes when creating a new GP program in
   * ProgramChromosome.
   *
  ...
  /**
   * @return true: do not clone_ICloneable command genes when creating a new GP program in
   * ProgramChromosome
   *
   * @author Klaus Meffert
   * @since 3.4.3

...
public class ForLoopTest
  ...
  public void testClone_0()
    ...
    Object clone = ( (ICloneable) gene).clone_ICloneable();
    assertEquals(clone, gene);
    CommandGene gene2 = new ForLoop(m_gpconf, Double.class, 0, 5);
    Object clone2 = ( (ICloneable) gene2).clone_ICloneable();
  ...
  public void testClone_1()
    ...
    ForLoop clone = (ForLoop) ( (ICloneable) gene).clone_ICloneable();
    assertEquals(clone, gene);
    assertEquals(2, clone.getArity(null));
    CommandGene gene2 = new ForLoop(m_gpconf, Double.class, 0, 5);
    ForLoop clone2 = (ForLoop) ( (ICloneable) gene2).clone_ICloneable();

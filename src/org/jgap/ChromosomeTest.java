...
public class ChromosomeTest
  ...
  public void testClone_5()
    ...
    Chromosome chrom2 = (Chromosome) chrom.clone_ICloneable();
    assertEquals(chrom, chrom2);
    conf.getChromosomePool().releaseChromosome(chrom);
    assertEquals(Chromosome.class, chrom.clone_ICloneable().getClass());
    chrom.cleanup();
  ...
  public void testClone_6()
    ...
    Chromosome chrom2 = (Chromosome) chrom.clone_ICloneable();
    assertEquals(chrom, chrom2);
    Chromosome chrom3 = (Chromosome) chrom.clone_ICloneable();
    assertEquals(chrom3, chrom2);
  }

  /**
   * Test clone_ICloneable with configuration set.
   *
  ...
  /**
   * Test clone_ICloneable with set application data implementing interface Cloneable,
  ...
  public void testClone_2()
    ...
    Chromosome cloned = (Chromosome) chrom.clone_ICloneable();
    assertSame(appObj, cloned.getApplicationData());
  }

  /**
   * Test clone_ICloneable with set application data, where cloning supported. Access is
  ...
  public void testClone_3()
    ...
    chrom.setApplicationData(appObj);
    chrom2 = (Chromosome) chrom.clone_ICloneable();
    assertTrue(chrom.equals(chrom2));
  ...
  /**
   * Test clone_ICloneable with Gene's energy set (value should be considered, too).
   *
   * @throws InvalidConfigurationException
   *
   * @author Klaus Meffert
   ...
   * This test uses a chromosome with own clone_ICloneable method.
   * Thanx to Peter Molettiere for pointing out the problem with
   * Chromosome.clone_ICloneable().
   *
   * @throws Exception
   *
   * @author Klaus Meffert
  ...
  public void testClone_7()
    ...
    IChromosome copy = (IChromosome)chrom.clone_ICloneable();
    assertEquals(copy, chrom);
  }

  /**
   * Tests cloning of sub class of org.jgap.Chromosome.
   * This test uses a chromosome without own clone_ICloneable method.
   *
   * @throws Exception
   *
   * @author Klaus Meffert

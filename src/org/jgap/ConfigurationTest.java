...
//                            + "null" + " "
  ...
  public void testClone_0()
    ...
    conf.setPopulationSize(1);
    Configuration theClone = (Configuration)conf.clone_ICloneable();
  ...
  public void testClone_1()
    ...
    conf.addGeneticOperator(new MutationOperator(conf));
    conf.setPopulationSize(1);
    Configuration theClone1 = (Configuration)conf.clone_ICloneable();
    Configuration theClone2 = (Configuration)conf.clone_ICloneable();
